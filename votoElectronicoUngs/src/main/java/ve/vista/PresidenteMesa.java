...
import ve.controlador.ControladorVotacion;
...
import ve.modelo.dao.impl.EntidadDAOImpl;
import ve.modelo.dao.impl.EstadoDAOImpl;
import ve.modelo.dao.impl.VotanteDAOImpl;
...
public class PresidenteMesa extends JFrame {
	...
	public PresidenteMesa() {
		...
		btnHabilitar = new JButton("Habilitar Terminal");
		...
		btnHabilitar.setBounds(388, 372, 160, 25);
